        ...
        <div className={styles.headerContainer}>
          <div className={styles.headerWrapper}>
            ...
            <div className={styles.starWrapper}>
              <svg className={styles.starRating} xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"><path className ="star" d="M12 .587l3.668 7.568 8.332 1.151-6.064 5.828 1.48 8.279-7.416-3.967-7.417 3.967 1.481-8.279-6.064-5.828 8.332-1.151z"/></svg>
            </div>
            ...
            <div class="_xluqb9">
              <div class="_1jdtwz4">
                <div class="_c2acbp">
                  <button type="button" class="_qp12mwx">
                    <div class="_5kaapu">
                      <span class="_14tkmhr">
                        <svg aria-hidden="true" role="presentation" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style="display: block; height: 16px; width: 16px; fill: currentcolor;">
                          <g vector-effect="non-scaling-stroke" transform="translate(0,0)scale(1,1)" fill="none" fill-rule="evenodd" stroke="#000" stroke-width="2">
                ...
                <div>
                  <button type="button" class="_qp12mwx">
                    <div class="_5kaapu">
                      <span class="_14tkmhr">
                        <svg aria-hidden="true" role="presentation" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style="display: block; fill: none; height: 16px; width: 16px; stroke: currentcolor; stroke-width: 2; overflow: visible;">
